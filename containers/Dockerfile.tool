...
RUN python3 -m venv /venv && \
    /venv/bin/pip install --upgrade pip setuptools wheel -i https://mirrors.aliyun.com/pypi/simple/ && \
    /venv/bin/pip install --no-cache-dir -r sidecar-requirements.txt -i https://mirrors.aliyun.com/pypi/simple/
...
# Install kubectl (multi-architecture support)
ARG TARGETARCH
